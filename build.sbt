...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies += "dev.zio" %% "zio-config"          % "3.0.6",
    libraryDependencies += "dev.zio" %% "zio-config-magnolia" % "3.0.6",
    libraryDependencies += "dev.zio" %% "zio-config-typesafe" % "3.0.6",
